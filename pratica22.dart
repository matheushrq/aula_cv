...
class MenuSuspenso extends StatefulWidget {
  @override
  _MenuSuspensoState createState() => _MenuSuspensoState();
}

class _MenuSuspensoState extends State<MenuSuspenso> {
  ...
  @override
  void initState() {
    listaProdutosMenu = ListaMenu.getListaProdutosMenu(Produto.getProdutos());
    produtoSelecionado = listaProdutosMenu![0].value;
    super.initState();
  }
}
